...
import { usePathname } from "next/navigation"; // Path kontrolü eklendi
...
const Footer = () => {
  ...
  const pathname = usePathname(); // Sayfa kontrolü

  const isDesign = mode === "design";
  
  // Gradient ayarı (Eski Tasarım Korundu)
  const logoGradient = isDesign
    ? "from-purple-600 to-pink-500"
    : "from-blue-600 to-cyan-500";

  // --- AKILLI SCROLL MANTIĞI (Header ile aynı) ---
  const handleScrollToSection = (e: React.MouseEvent<HTMLAnchorElement>, sectionId: string) => {
    // 5 Dil Desteği İçin Ana Sayfa Kontrolü
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                <Link href="/" className="relative block mb-5">
                  <h2 className="text-3xl font-extrabold tracking-tight text-black dark:text-white">
                    ACR
                    <span className={`bg-gradient-to-r bg-clip-text text-transparent ${logoGradient}`}>
                      TECH
                    </span>
                  </h2>
                </Link>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                {/* KOLON 2: HIZLI LİNKLER (SCROLL ÖZELLİKLİ) */}
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: -20 },
                    visible: { opacity: 1, y: 0 },
                ...
                {/* KOLON 3: DESTEK (NORMAL SAYFA LİNKLERİ) */}
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: -20 },
                    visible: { opacity: 1, y: 0 },
                ...
                >
                  ...
                  <ul>
                    <li>
                      <Link href="/blog" className="mb-3 inline-block hover:text-primary">
                        {t("links.blog")}
                      </Link>
                    </li>
                    <li>
                      <Link href="/docs" className="mb-3 inline-block hover:text-primary">
                        {t("links.docs")}
                      </Link>
                    </li>
                    <li>
                      <Link href="/error" className="mb-3 inline-block hover:text-primary">
                        {t("privacy")}
                      </Link>
                    </li>
                    <li>
                ...
                {/* KOLON 4: NEWSLETTER (GÖRSEL TASARIM KORUNDU) */}
                <motion.div
                  variants={{
                    hidden: { opacity: 0, y: -20 },
                    visible: { opacity: 1, y: 0 },
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-8">
                ...
                <li>
                  <Link href="#" className="hover:text-primary">{t("support")}</Link>
                </li>
              </ul>
            </motion.div>
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} AcrTech. {t("rights")}
              </p>
            </motion.div>

            {/* SAĞ SOSYAL MEDYA (SVG'LER KORUNDU) */}
            <motion.div
              variants={{
                hidden: { opacity: 0, y: -20 },
                visible: { opacity: 1, y: 0 },
                ...
                <li>
                  <a href="#" aria-label="social icon">
                    <svg className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs><clipPath id="clip0_48_1499"><rect width="24" height="24" fill="white" /></clipPath></defs>
                    </svg>
                  </a>
                </li>
                {/* SVG 2 */}
                <li>
                  <a href="#" aria-label="social icon">
                    <svg className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs><clipPath id="clip0_48_1502"><rect width="24" height="24" fill="white" /></clipPath></defs>
                    </svg>
                  </a>
                </li>
                {/* SVG 3 */}
                <li>
                  <a href="#" aria-label="social icon">
                    <svg className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs><clipPath id="clip0_48_1505"><rect width="24" height="24" fill="white" /></clipPath></defs>
                    </svg>
                  </a>
                </li>
                {/* SVG 4 */}
